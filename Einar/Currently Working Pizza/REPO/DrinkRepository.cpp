...
void DrinkRepository::read_drinklist()      /// This function is used to read from DrinkList.txt into the price_vector ///
{
    ifstream fin;
    string str;
...
void DrinkRepository::read_drinkpricelist()     /// This function is used to read from Drinkprice.txt into the drink_vector ///
{
    ifstream fin;
    string str;
